...
<tr><td><img src="./mFlag.PNG"></td><td>Implied mined</td><td>base on planted Proposed flag, this slate must be mined</td><td></td><td></td><td>auto</td></tr>
...
value without first opening the slate.  To open a slate, one can only do it via the Slate method:
```python
